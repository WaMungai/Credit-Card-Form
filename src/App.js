...
function ThankYou ({setConfirmed}){
  return(
    ...
    <div className="thank-you flex flex-col items-center justify-center lg:h-screen max-w-lg mx-auto">
      <img src={tick} alt="" className="bollc mx-auto" />
      <h1 className="text-slate-800 tex-3xl my-6 uppercase tex-center">Thank you!</h1>
      <p className="text-slate-400 tex-center">
